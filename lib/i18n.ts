...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      duplicate: "Duplicate",
      phoneTableId: "ID",
      phoneTableClient: "Client",
      phoneTablePhone: "Phone",
      phoneTablePrice: "Price",
      phoneTableStatus: "Status",
      phoneSearchEmpty: "No matching products found.",
    },
    companies: {
      ...
      analyticsTotal: "Total Products",
      analyticsDelivered: "Delivered",
      analyticsInDelivery: "In Delivery",
      analyticsCanceled: "Canceled",
      analyticsRevenue: "Revenue (delivered)",
      analyticsAvgPrice: "Avg. Price",
      analyticsDeliveredRatio: "Delivered Ratio",
    },
    stock: {
    ...
    workers: {
      ...
      analytics: "Analytics",
      analyticsTitle: "Worker Analytics - {name}",
      analyticsCurrentTab: "Current",
      analyticsArchiveTab: "Archive",
      analyticsDeliveredCount: "Delivered products",
      analyticsRevenue: "Money we got",
      analyticsWorkerBenefit: "Worker benefit",
      analyticsNetBenefit: "Our net benefit",
      analyticsSystemBenefit: "System benefit",
      analyticsArchiveAction: "Archive results",
      analyticsDeleteArchive: "Delete archive",
      analyticsUndoArchive: "Undo",
      analyticsArchiveEmpty: "No archived analytics for this worker.",
      analyticsArchivedTitle: "Analytics archived",
      analyticsArchivedDesc: "Current results were archived.",
      analyticsArchivedHidden: "Current analytics are archived. You can see them in the Archive tab.",
      analyticsNoDataTitle: "No analytics to archive",
      analyticsNoDataDesc: "This worker has no delivered products yet.",
    },
    sheets: {
      title: "Worker Sheets",
      ...
      inDeliveryTab: "In delivery",
      historyTab: "Validated history",
      detachedStatus: "Detached",
      noDeliveryProducts: "No in-delivery products.",
      noHistoryProducts: "No validated history yet.",
      validateSuccessTitle: "Sheet validated",
      validateSuccessDesc: "Statuses were updated successfully.",
    },
    adminsSection: {
    ...
    treasure: {
      ...
      cards: {
        ...
        revenueHint: "Sum of delivered product prices",
        workerFees: "Worker Fees",
        workerFeesHint: "Total commissions paid",
        final: "Final Benefit",
        finalHint: "Revenue",
        systemBenefit: "System Benefit",
        systemBenefitHint: "Revenue - worker fees",
        companyMoney: "Company Money",
        companyMoneyHint: "System benefit - final benefit",
      },
  ...
  fr: {
    ...
    dashboard: {
      ...
      phoneTableId: "ID",
      phoneTableClient: "Client",
      phoneTablePhone: "Téléphone",
      phoneTablePrice: "Prix",
      phoneTableStatus: "Statut",
      phoneSearchEmpty: "Aucun produit correspondant.",
    },
    companies: {
      ...
      analyticsTotal: "Produits totaux",
      analyticsDelivered: "Livrés",
      analyticsInDelivery: "En livraison",
      analyticsCanceled: "Annulés",
      analyticsRevenue: "Revenu (livrés)",
      analyticsAvgPrice: "Prix moyen",
      analyticsDeliveredRatio: "Taux de livraison",
    },
    stock: {
    ...
    workers: {
      ...
      analyticsTitle: "Analytique du livreur - {name}",
      analyticsCurrentTab: "Actuel",
      analyticsArchiveTab: "Archive",
      analyticsDeliveredCount: "Produits livrés",
      analyticsRevenue: "Argent reçu",
      analyticsWorkerBenefit: "Bénéfice du livreur",
      analyticsNetBenefit: "Notre bénéfice net",
      analyticsSystemBenefit: "Bénéfice du système",
      analyticsArchiveAction: "Archiver les résultats",
      analyticsDeleteArchive: "Supprimer l'archive",
      analyticsUndoArchive: "Annuler",
      analyticsArchiveEmpty: "Aucune analytique archivée pour ce livreur.",
      analyticsArchivedTitle: "Analytique archivée",
      analyticsArchivedDesc: "Les résultats actuels ont été archivés.",
      analyticsArchivedHidden: "L'analytique actuelle est archivée. Vous pouvez la voir dans l'onglet Archive.",
      analyticsNoDataTitle: "Aucune analytique à archiver",
      analyticsNoDataDesc: "Ce livreur n'a encore aucun produit livré.",
    },
    sheets: {
      ...
      inDeliveryTab: "En livraison",
      historyTab: "Historique validé",
      detachedStatus: "Détaché",
      noDeliveryProducts: "Aucun produit en livraison.",
      noHistoryProducts: "Aucun historique validé pour le moment.",
      validateSuccessTitle: "Feuille validée",
      validateSuccessDesc: "Les statuts ont été mis à jour avec succès.",
    },
    adminsSection: {
    ...
    treasure: {
      ...
      cards: {
        ...
        revenueHint: "Somme des prix des produits livrés",
        workerFees: "Frais livreurs",
        workerFeesHint: "Commissions totales",
        final: "Bénéfice final",
        finalHint: "Revenu",
        systemBenefit: "Bénéfice système",
        systemBenefitHint: "Revenu - frais livreurs",
        companyMoney: "Argent entreprise",
        companyMoneyHint: "Bénéfice système - bénéfice final",
      },
  ...
  ar: {
    ...
    dashboard: {
      ...
      phoneSearch: "البحث برقم الهاتف",
      phoneSearchPlaceholder: "ابحث برقم الهاتف...",
      showDuplicates: "عرض المكرّرات",
      duplicate: "مكرّر",
      phoneTableId: "المعرّف",
      phoneTableClient: "العميل",
      phoneTablePhone: "الهاتف",
      phoneTablePrice: "السعر",
      phoneTableStatus: "الحالة",
      phoneSearchEmpty: "لم يتم العثور على منتجات مطابقة.",
    },
    companies: {
      title: "شركات الشركاء",
      ...
      analyticsTotal: "إجمالي المنتجات",
      analyticsDelivered: "تم التسليم",
      analyticsInDelivery: "قيد التوصيل",
      analyticsCanceled: "ملغاة",
      analyticsRevenue: "الإيراد (المسلّم)",
      analyticsAvgPrice: "متوسط السعر",
      analyticsDeliveredRatio: "نسبة التسليم",
    },
    stock: {
      title: "إدارة المخزون",
    ...
    workers: {
      ...
      analytics: "التحليلات",
      analyticsTitle: "تحليلات العامل - {name}",
      analyticsCurrentTab: "الحالي",
      analyticsArchiveTab: "الأرشيف",
      analyticsDeliveredCount: "المنتجات المسلّمة",
      analyticsRevenue: "الأموال التي حصلنا عليها",
      analyticsWorkerBenefit: "فائدة العامل",
      analyticsNetBenefit: "فائدتنا الصافية",
      analyticsSystemBenefit: "فائدة النظام",
      analyticsArchiveAction: "أرشفة النتائج",
      analyticsDeleteArchive: "حذف الأرشيف",
      analyticsUndoArchive: "تراجع",
      analyticsArchiveEmpty: "لا توجد تحليلات مؤرشفة لهذا العامل.",
      analyticsArchivedTitle: "تمت أرشفة التحليلات",
      analyticsArchivedDesc: "تمت أرشفة النتائج الحالية.",
      analyticsArchivedHidden: "التحليلات الحالية مؤرشفة. يمكنك رؤيتها في تبويب الأرشيف.",
      analyticsNoDataTitle: "لا توجد تحليلات للأرشفة",
      analyticsNoDataDesc: "هذا العامل لا يملك منتجات مسلّمة بعد.",
    },
    sheets: {
      title: "كشوفات العمال",
      ...
      assigning: "جارٍ الإسناد...",
      validateResults: "تأكيد النتائج",
      inDeliveryTab: "قيد التوصيل",
      historyTab: "سجل النتائج المعتمدة",
      detachedStatus: "مفصول",
      noDeliveryProducts: "لا توجد منتجات قيد التوصيل.",
      noHistoryProducts: "لا يوجد سجل نتائج معتمد بعد.",
      validateSuccessTitle: "تم اعتماد الكشف",
      validateSuccessDesc: "تم تحديث الحالات بنجاح.",
    },
    adminsSection: {
    ...
    treasure: {
      ...
      cards: {
        ...
        revenueHint: "مجموع أسعار المنتجات المسلّمة",
        workerFees: "رسوم العمال",
        workerFeesHint: "إجمالي العمولات",
        final: "الفائدة النهائية",
        finalHint: "الإيراد",
        systemBenefit: "فائدة النظام",
        systemBenefitHint: "الإيراد - رسوم العمال",
        companyMoney: "مال الشركة",
        companyMoneyHint: "فائدة النظام - الفائدة النهائية",
      },
